...
public class Location {
	...
	// Calcul du montant de la location en fonction du prix par jour des
	// articles et de la durée
	public void calculMontant() {
		double prix = 0;
		long diff = this.dateDebut.getTime() - this.getDateFin().getTime()/86399993;
